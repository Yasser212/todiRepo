                    ...
                    <div class="text-2xl px-8">
                        ...
                        <div class="my-3">
                            ...
                            <a class="h-8 w-8 rounded-full outline-none focus:outline-none"
                                href="https://www.linkedin.com" type="button">
                            ...
                            <a class=" h-8 w-8 rounded-full outline-none focus:outline-none"
                                href="https://www.reddit.com" type="button">
                                <svg class="fill-current cursor-pointer text-gray-200 hover:text-gray-600" width="24"
                                    height="24" viewBox="0 0 24 24">
                                    <path
            ...
            <div class="flex flex-wrap items-center md:justify-between justify-center">
                <div class="w-full md:w-4/12 px-4 mx-auto text-center">
                    <div class="text-sm text-gray-200 py-1">
                        ...
                        <a href="https://github.com/Yasser212" class="text-gray-200 hover:text-gray-400">Yasser
                            Alsayed</a>.
                    </div>
                </div>
            </div>
