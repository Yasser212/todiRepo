                ...
                <div class="flex flex-wrap items-top">
                    <div class="w-full lg:w-4/12  px-4 ml-auto">
                        ...
                        <ul class="list-unstyled">
                            <li>
                                <a class="text-gray-200 hover:text-gray-400 pb-2 text-sm"
                                    href="/source?q=bbc-news">BBC</a>
                            </li>
                            <li>
                                <a class="text-gray-200 hover:text-gray-400 pb-2 text-sm" href="/source?q=cnn">CNN</a>
                            </li>
                            <li>
                                <a class="text-gray-200 hover:text-gray-400 pb-2 text-sm"
                                    href="/source?q=fox-news">Fox</a>
                            </li>
                            <li>
                                <a class="text-gray-200 hover:text-gray-400 pb-2 text-sm"
                                    href="/source?q=google-news">Google</a>
                            </li>
                        </ul>
                    </div>

                    <div class="w-full lg:w-4/12 px-4">
                        <h3 class="font-bold text-sm text-gray-100 mb-2">Categories</h3>
                        <ul class="list-unstyled">
                            <li>
                                <a class="text-gray-200 hover:text-gray-400 pb-2 text-sm"
                            ...
                            <li>
                                <a class="text-gray-200 hover:text-gray-400 pb-2 text-sm" href="/category?q=science">
                                    Science
                                </a>
                            </li>
                            <li>
                                <a class="text-gray-200 hover:text-gray-400 pb-2 text-sm" href="/category?q=sports">
                                    Sports
                                </a>
                            </li>
                            <li>
                                <a class="text-gray-200 hover:text-gray-400 pb-2 text-sm" href="/category?q=health">
                                    Health
                                </a>
                            </li>
                        </ul>
        ...
        <div class="flex flex-wrap items-center md:justify-between justify-center">
            <div class="w-full md:w-4/12 px-4 mx-auto text-center">
                <div class="text-sm text-gray-200 py-1">
                    ...
                    <a href="https://github.com/Yasser212" class="text-gray-200 hover:text-gray-400">Yasser Alsayed</a>.
                </div>
            </div>
        </div>
    </div>
